...
const schema = Joi.object({
  ...
  WHATSAPP_CHAT_ID:             Joi.string().allow('').default(''),
  GREEN_API_INSTANCE_ID:        Joi.string().allow('').default(''),
  GREEN_API_TOKEN:              Joi.string().allow('').default(''),
  GREEN_API_URL:                Joi.string().default('7107.api.greenapi.com'),
...
export const CONFIG = {
  ...
  WHATSAPP_CHAT_ID:       e.WHATSAPP_CHAT_ID,
  GREEN_API_INSTANCE_ID:  e.GREEN_API_INSTANCE_ID,
  GREEN_API_TOKEN:        e.GREEN_API_TOKEN,
  GREEN_API_URL:          e.GREEN_API_URL,
